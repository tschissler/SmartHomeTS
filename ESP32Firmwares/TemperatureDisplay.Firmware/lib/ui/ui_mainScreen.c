...
void ui_mainScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_lblVersion, "v0.0.0");
    ...
    lv_obj_set_x(ui_lblTempOutside, 110);
    ...
    lv_obj_set_x(ui_lblTempOutsideGarden, -30);
    ...
    lv_obj_set_style_text_align(ui_lblTempOutsideGarden, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_lblTempOutsideGarden, &ui_font_Quantico_32, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_lblSeparator = lv_label_create(ui_Container1);
    lv_obj_set_width(ui_lblSeparator, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_lblSeparator, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_lblSeparator, 40);
    lv_obj_set_y(ui_lblSeparator, 0);
    lv_obj_set_align(ui_lblSeparator, LV_ALIGN_CENTER);
    lv_label_set_text(ui_lblSeparator, "/");
    lv_obj_set_style_text_color(ui_lblSeparator, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_lblSeparator, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_lblSeparator, &ui_font_Quantico_32, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_height(ui_btnTransfer, 77);
    lv_obj_set_x(ui_btnTransfer, -337);
    lv_obj_set_y(ui_btnTransfer, -141);
    ...
    ui_object_set_themeable_style_property(ui_btnTransfer, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_Success);
    ui_object_set_themeable_style_property(ui_btnTransfer, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_Success);

    ui_Image1 = lv_image_create(ui_btnTransfer);
    lv_image_set_src(ui_Image1, &ui_img_export_png);
    ...
    ui_Label2 = lv_label_create(ui_btnTransfer);
    lv_obj_set_width(ui_Label2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label2, 0);
    lv_obj_set_y(ui_Label2, 25);
    lv_obj_set_align(ui_Label2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label2, "Übertragen");
    lv_obj_set_style_text_font(ui_Label2, &ui_font_Quantico_16, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_btnCancel = lv_button_create(ui_mainScreen);
    lv_obj_set_width(ui_btnCancel, 100);
    lv_obj_set_height(ui_btnCancel, 77);
    lv_obj_set_x(ui_btnCancel, 50);
    lv_obj_set_y(ui_btnCancel, -141);
    lv_obj_set_align(ui_btnCancel, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_btnCancel, LV_OBJ_FLAG_HIDDEN | LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_remove_flag(ui_btnCancel, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_btnCancel, lv_color_hex(0x650101), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_btnCancel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image2 = lv_image_create(ui_btnCancel);
    lv_image_set_src(ui_Image2, &ui_img_cancel_png);
    ...
    ui_Label4 = lv_label_create(ui_btnCancel);
    lv_obj_set_width(ui_Label4, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label4, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label4, 0);
    lv_obj_set_y(ui_Label4, 25);
    lv_obj_set_align(ui_Label4, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label4, "Abbrechen");
    lv_obj_set_style_text_font(ui_Label4, &ui_font_Quantico_16, LV_PART_MAIN | LV_STATE_DEFAULT);

...
| 11 Zuordnung | `laden-11-zuordnung` | 2026-09-20 | läuft — Evidenzstufen als reine Funktion in der RulesEngine, eigenes retained Topic `daten/Laden/M3/<Box>/Zuordnung`, Vertrauensgrad in der Kachel. Achtung: RulesEngine referenziert `SharedContracts` bisher nicht → Pfadfilter und Dockerfile müssen mit |

...
| 12 Energieaufteilung | `laden-12-energieaufteilung` | 2026-09-20 | **fertig**, Commits `be3ad60` + `3359156`, Merge offen. Tests **94/94 grün** (48 neu), von mir selbst nachgelaufen; kein Erwartungswert der 46 Alttests angefasst. Neues Topic `daten/Laden/M3/<Box>/Energieaufteilung`, retained. Löst **sechs** Rollouts aus (`SharedContracts`) |

...
| 10 Fahrzeugdaten | `laden-10-fahrzeugdaten` | 2026-09-20 | läuft — fehlende Felder in `CarStatusData`, Fahrzeugkarten mit Altersanzeige, **zweiter harter Schnitt**: `data/charging/<Auto>` → `daten/Fahrzeug/<Auto>/Status`. Achtung `*_OUTPUT_TOPIC` im Deployment. Entsperrt 11 und 17 |

...
**Die Haken in den Punkt-Abschnitten sind nicht gepflegt.** Arbeits-Sessions dürfen dieses
Dokument nicht anfassen, und die Integrator-Session hat den Stand in dieser Tabelle geführt
statt in den `- [ ]`. **Maßgeblich ist die Tabelle**, nicht die Kästchen weiter unten — wer
nur die Abschnitte liest, sieht über achtzig offene Haken und denkt, es sei nichts passiert.
Aufgefallen am 2026-09-20 beim Versuch, den offenen Rest auszuzählen.
